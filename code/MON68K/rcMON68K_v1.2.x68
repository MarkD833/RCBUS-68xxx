...
MON_BASE		EQU		$7000		* Monitor base addr = 0000_7000
...
DUART_BASE		EQU		$F00180		* SCC68692 base addr = $180

* Set the stack to RAM_BASE + RAM_LEN - 2048 allowing space for any private
* variables we may need.
*
STACK_START		EQU		RAM_BASE+RAM_LEN-2048
...
.bootCPM:
    ...
    * I don't think CP/M-68K can return back to the BIOS but just in case it can
