...
;										    										*
;	This version is for the RCBus-68000 board.       		            			*
;	Based on the version by Jeff Tranter (tranter@pobox.com)   						*
;										    										*
;************************************************************************************
;										    										*
...
ROM_START	EQU	EHBASIC_BASE

; Ver 3.55 - MJD renamed ram_base, ram_addr, ram_size to ehram_base, ehram_addr,
;            ehram_size to deconflict with my own monitor variables.
; Ver 3.54
...
; MJD I don't need the initial SP & START address from the exception vector table
;     as code_start will be callled from my ROM Monitor program.
;	ORG	$00000000
;
;INIVEC:
	;; 0-7
;	DC.L	ehram_addr+ehram_base	; Reset: Initial SSP
...
; Use this value to run out of RAM
	ORG		ROM_START			; past the vectors in a real system
	JMP		code_start
...
; in d0. these values are at the end of the .inc file
	...
	MOVEA.l	#ehram_addr,a0			; tell BASIC where RAM starts
	MOVE.l	#ehram_size,d0			; tell BASIC how much RAM there is
...
;LAB_sizok
	...
	MOVE.l	#ehram_addr+ehram_base,sp	; set stack to RAM start + 1k
...
LAB_1491
	...
	MOVE.l	#ehram_addr+ehram_base,sp	; set stack to RAM start + 1k, flush stack
...
LAB_RAM
	LEA		ehram_base,a0			; get start of EhBASIC RAM
